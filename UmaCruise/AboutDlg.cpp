...
LRESULT CAboutDlg::OnInitDialog(UINT, WPARAM, LPARAM, BOOL&)
{
	...
	wndVersionCheck.SetWindowText(L"Debugging");
#else
...
LRESULT CAboutDlg::OnLinkClickDB(int, LPNMHDR, BOOL&)
{
	::ShellExecute(NULL, nullptr, L"https://github.com/RyoLee/UmaUmaCruise-db-urarawin", nullptr, nullptr, SW_NORMAL);
	return LRESULT();
}
LRESULT CAboutDlg::OnLinkClickOriHomePage(int, LPNMHDR, BOOL&)
{
...
{
	::ShellExecute(NULL, nullptr, L"https://github.com/RyoLee/UmaCruise-U", nullptr, nullptr, SW_NORMAL);
	return LRESULT();
}
